...
# Setup:
# docker run --publish 8080:8080 --net=kv_subnet --ip=10.10.0.2 --name="kvs1" --env ADDRESS="10.10.0.2:8080" kvs:1.0
# docker run --publish 8081:8080 --net=kv_subnet --ip=10.10.0.3 --name="kvs2" --env ADDRESS="10.10.0.3:8080" kvs:1.0
# docker run --publish 8082:8080 --net=kv_subnet --ip=10.10.0.4 --name="kvs3" --env ADDRESS="10.10.0.4:8080" kvs:1.0
...
class TestAssignment1(unittest.TestCase):
    ...
    def test_delete_broadcast(self): # checks for broadcast of put and broadcast of delete
        res = put(kvs_view_admin_url(ports[0], hosts[0]),
                  put_view_body(view_addresses))
        self.assertEqual(res.status_code, 200, msg='Bad status code')
        ...
        res = delete(kvs_data_key_url(keys[1], ports[2], hosts[2]), put_val_body(vals[1], cm))
